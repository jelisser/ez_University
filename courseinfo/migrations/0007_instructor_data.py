...
def add_instructor_data(apps, schema_editor):
    Instructor = apps.get_model('courseinfo', 'Instructor')
    for instructor in INSTRUCTORS:
        try:
            duplicate_object = Instructor.objects.get(
            ...
            instructor_object = Instructor.objects.create(
                first_name=instructor['first_name'],
                last_name=instructor['last_name']
            )
...
def remove_instructor_data(apps, schema_editor):
    Instructor = apps.get_model('courseinfo', 'Instructor')
    for instructor in INSTRUCTORS:
        instructor_object = Instructor.objects.get(
            first_name=instructor['first_name'],
            last_name=instructor['last_name'],
        )
